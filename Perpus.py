...
def main():
    st.title("Selamat Datang di Portal Pencarian Koleksi Buku di Perpustakaan Jurusan Elektro")
    st.write("Portal ini hanya menyediakan koleksi buku bidang teknik informatika")
    # Memuat data buku
    books = load_books()
